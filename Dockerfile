...
RUN chmod +x /usr/local/bin/install-php-extensions && \
    IPE_GD_WITHOUTAVIF=1 install-php-extensions bcmath exif gd igbinary imagick/imagick@28f27044e435a2b203e32675e942eb8de620ee58 imap intl ldap memcached mysqli opcache pcntl pdo_mysql pdo_pgsql pgsql redis ssh2 xdebug zip @composer
